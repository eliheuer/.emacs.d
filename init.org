...
#+AUTHOR: Eli Heuer
=======
#+AUTHOR: Rakhim Davletkaliyev and Eli Heuer
>>>>>>> 8ace16cfeb2a6daa2bcd727c3f9abb64bf568388
#+BABEL: :cache yes
...
Forked from the Emacs podcast guy's config.
** TODO Add link to podcast
* Installing
...
#+BEGIN_SRC emacs-lisp
<<<<<<< HEAD
(set-face-attribute 'default nil :font "InputMonoCondensed 16")
=======
(set-face-attribute 'default nil :font "InputMonoCondensed 18")
>>>>>>> 8ace16cfeb2a6daa2bcd727c3f9abb64bf568388
...
This is a test of speling tols
#+BEGIN_SRC emacs-lisp
